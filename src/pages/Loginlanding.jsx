            ...
            sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
                ...
                <div className="w-full  max-w-md animate-fade-in relative z-10">
                    ...
                    <div className="mb-10 text-center md:text-left">
                        ...
                        <p className="text-slate-500">Select your portal  new to securely access the system.</p>
                    </div>
                    {/* Portals List */}
                            ...
                            <Link key={portal.to} to={portal.to}
                                ...
                                <div className="relative z-10 flex items-center
                                 justify-between gap-4 sm:gap-5">
                                    <h3 className="text-lg text-slate-800 group-hover:text
                                    indigo-600 mb-1 transition-colors">{portal.tittle}</h3>
                                    <ArrowRightIcon className="w-4 h-4 text-slate-400 group-hover:translate
