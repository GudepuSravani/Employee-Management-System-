...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text
            -white shrink-0 border-r border-white/4'>
                {sidebarContent}
            </aside>
            ...
            <aside className={` lg:hidden fixed inset-y-0 left-0 w-72
                ...
                z-50 flex flex-col transform transition-transorm duration-300 
